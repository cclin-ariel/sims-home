<template>
  <div>
    <div class="mt-10 mb-5 max-w-1600px">
      <div class="uppercase font-mono pl-2 flex justify-center text-xl tracking-wide">
        INSPIRATION DELIVERED
        <div class="md:hidden ml-3"><button><i class="fas fa-caret-down"></i></button></div>
      </div>
        ...
        <div class="mx-5 my-5 md:my-10">
          <router-link to="/sims_home/shop_inspirationIdea" class="">
            <img
              ...
              alt="wall-paper"
          /></router-link>
          <div class="w-full text-center capitalize font-serif mt-8">
            bedrooms
          </div>
